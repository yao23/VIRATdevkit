function record=VIRATreadrectxt(filename)
  ...
  filename = '~/Projects/object_detection/tools/mywork/VIRAT_Video/Annotations/VIRAT_S_000001.viratdata.objects.txt';
  rec = load(filename);
  xmin = rec(1, 4);
  xmax = rec(1, 4) + rec(1, 6);
  ymin = rec(1, 5);
  ymax = rec(1, 5) + rec(1, 7);
